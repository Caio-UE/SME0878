"""Funcoes de apoio para limpar e padronizar o texto vindo do Transfermarkt.

Os dados chegam como texto pensado para leitura humana, com simbolos de moeda,
sufixos como m ou k, datas em formatos variados e tracos representando ausencia.
Estas funcoes convertem esse texto em valores estruturados: valor de mercado em euros
inteiros, datas em objetos date e enderecos reduzidos apenas ao caminho. Centralizar o
tratamento aqui garante que todos os spiders limpem os dados da mesma forma.
"""
