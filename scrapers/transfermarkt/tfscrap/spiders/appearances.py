"""Estatisticas de desempenho por competicao e temporada.

Para cada jogador, este spider acessa a aba de dados de desempenho (leistungsdaten) e
percorre todas as temporadas disponiveis no seletor da pagina. Em cada temporada, gera
uma linha por competicao com os numeros agregados: jogos, gols, assistencias, cartoes e
minutos jogados. A leitura de todas as temporadas e feita em duas etapas: a primeira
requisicao descobre quais temporadas existem e as demais buscam cada uma delas.
"""
...
class AppearancesSpider(BaseSpider):
    """Uma linha por jogador, competicao e temporada, com estatisticas agregadas."""

    name = "appearances"

    def _leistungsdaten_url(self, href: str, season: str | None = None) -> str:
        # Converte a URL de perfil na URL de dados de desempenho e, quando informada,
        # anexa a temporada desejada como parametro de consulta.
