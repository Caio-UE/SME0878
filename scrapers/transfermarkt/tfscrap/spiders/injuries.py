"""Historico de lesoes de cada jogador.

Acessa a aba de lesoes (verletzungen) do jogador e gera uma linha por lesao registrada,
com temporada, tipo de lesao, datas de inicio e fim, total de dias afastado e numero de
jogos perdidos. Esses dados sustentam a analise de risco fisico do atleta, ja que a
disponibilidade em campo afeta diretamente o valor de mercado.
"""
...
class InjuriesSpider(BaseSpider):
    """Uma linha por lesao registrada na aba de lesoes do jogador."""
