"""Terceiro nivel do scraping: o perfil de cada jogador.

A partir da lista de jogadores de um clube, este spider abre a pagina de perfil de
cada atleta e extrai os dados biograficos e tecnicos: nome, data de nascimento e idade,
nacionalidade, posicao, pe preferido, altura, data de entrada no clube, fim de contrato
e valor de mercado atual. Boa parte desses campos vem como texto livre, entao usamos
expressoes regulares para separar, por exemplo, a data de nascimento da idade e a altura
em metros do numero em centimetros. A saida alimenta os spiders de estatisticas, lesoes,
transferencias e historico de valor de mercado.
"""
...
class PlayersSpider(BaseSpider):
    """Abre a pagina de perfil de cada jogador e extrai seus dados biograficos."""
    ...
    def _parse_height_cm(raw: str | None):
        ...
        # converte a altura de metros para centimetros, por exemplo "1,95 m" vira 195
