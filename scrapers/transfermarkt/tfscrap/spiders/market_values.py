"""Historico de valor de mercado de cada jogador.

Tambem consome uma API interna em JSON (ceapi). Para cada jogador, gera uma linha por
ponto do grafico de evolucao do valor de mercado, com a data, o valor naquele momento e
o clube em que o atleta estava. Esses pontos formam a serie temporal usada para medir
valorizacao e depreciacao ao longo da carreira.
"""
...
class MarketValuesSpider(BaseSpider):
    """Le o historico de valor de mercado da API interna, um ponto por data."""
